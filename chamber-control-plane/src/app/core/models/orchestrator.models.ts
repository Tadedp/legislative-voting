...
export interface OrchestratorEvent {
  event_type: 'SESSION_STATUS_CHANGED' | 'AGENDA_ITEM_UPDATED' | 'VOTING_ROUND_OPENED' | 'VOTING_ROUND_CLOSED' | 'VOTING_ROUND_ABORTED' | 'VOTING_ROUND_RESOLVED' | 'VOTE_CAST' | 'QUORUM_WARNING';
